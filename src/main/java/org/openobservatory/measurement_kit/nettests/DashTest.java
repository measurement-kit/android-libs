...
public class DashTest implements BaseTest {
    private org.openobservatory.measurement_kit.swig.DashTest wrapper
        = new org.openobservatory.measurement_kit.swig.DashTest();

    public DashTest set_verbosity(long verbosity) {
        wrapper.set_verbosity(verbosity);
        return this;
    }

    public DashTest increase_verbosity() {
        wrapper.increase_verbosity();
        return this;
    }

    public DashTest add_input(String input) {
        wrapper.add_input(input);
	return this;
    }

    @Deprecated
    public DashTest set_input_filepath(String fpath) {
        wrapper.set_input_filepath(fpath);
        return this;
    }

    public DashTest set_output_filepath(String fpath) {
        wrapper.set_output_filepath(fpath);
        return this;
    }

    public DashTest set_error_filepath(String fpath) {
        wrapper.set_error_filepath(fpath);
        return this;
    }

    public DashTest use_logcat() {
        wrapper.use_logcat();
        return this;
    }

    public DashTest on_log(LogCallback delegate) {
        wrapper.on_log(delegate);
        return this;
    }

    public DashTest on_log(final String event_id, final IntentRouter router) {
    ...
    public DashTest on_progress(ProgressCallback delegate) {
        wrapper.on_progress(delegate);
        return this;
    }

    public DashTest on_progress(final String event_id, final IntentRouter router) {
    ...
    public DashTest on_event(EventCallback delegate) {
        wrapper.on_event(delegate);
        return this;
    }

    public DashTest on_event(final String event_id, final IntentRouter router) {
    ...
    public DashTest on_entry(EntryCallback delegate) {
        wrapper.on_entry(delegate);
        return this;
    }

    public DashTest on_entry(final String event_id, final IntentRouter router) {
    ...
    @Deprecated
    public DashTest set_options(String key, String value) {
        wrapper.set_option(key, value);
        return this;
    }

    public DashTest set_option(String key, String value) {
        wrapper.set_option(key, value);
        return this;
    }
