...
public class DnsInjectionTest implements BaseTest {
    private org.openobservatory.measurement_kit.swig.DnsInjectionTest wrapper
        = new org.openobservatory.measurement_kit.swig.DnsInjectionTest();

    public DnsInjectionTest set_verbosity(long verbosity) {
    ...
    public DnsInjectionTest add_input(String input) {
        wrapper.add_input(input);
	return this;
    }

    @Deprecated
    public DnsInjectionTest set_input_filepath(String fpath) {
        wrapper.set_input_filepath(fpath);
        return this;
    }

    public DnsInjectionTest set_output_filepath(String fpath) {
        wrapper.set_output_filepath(fpath);
        return this;
    }

    public DnsInjectionTest set_error_filepath(String fpath) {
    ...
    public DnsInjectionTest on_log(LogCallback delegate) {
        wrapper.on_log(delegate);
        return this;
    }

    public DnsInjectionTest on_log(final String event_id, final IntentRouter router) {
    ...
    public DnsInjectionTest on_progress(ProgressCallback delegate) {
        wrapper.on_progress(delegate);
        return this;
    }

    public DnsInjectionTest on_progress(final String event_id, final IntentRouter router) {
    ...
    public DnsInjectionTest on_event(EventCallback delegate) {
        wrapper.on_event(delegate);
        return this;
    }

    public DnsInjectionTest on_event(final String event_id, final IntentRouter router) {
    ...
    public DnsInjectionTest on_entry(EntryCallback delegate) {
        wrapper.on_entry(delegate);
        return this;
    }

    public DnsInjectionTest on_entry(final String event_id, final IntentRouter router) {
    ...
    @Deprecated
    public DnsInjectionTest set_options(String key, String value) {
        wrapper.set_option(key, value);
        return this;
    }

    public DnsInjectionTest set_option(String key, String value) {
        wrapper.set_option(key, value);
        return this;
    }
